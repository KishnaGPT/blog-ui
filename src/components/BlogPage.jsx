...
function BlogPage() {
  ...
  return (
    <>
      {/* ================= HERO ================= */}
      <section className="grid md:grid-cols-2 gap-12 items-center py-16 px-8">
        <div style={{
    ...
    width: "100%"}}>
          <h1 className="text-4xl font-bold leading-tight">
            Great<span className="text-blue-600">Hire</span> Insights – The
            Future of Work
          </h1>
          <p className="mt-4 text-gray-600">
            Your all-in-one platform connecting talent with opportunity.
          </p>
          <p className="mt-3 italic font-semibold text-gray-500">– GreatHire</p>
        </div>
      </section>
